...
'快速添加空行
nnoremap [<space> :<c-u>put! repear(nr2char(10),v:count1)<cr>'[
nnoremap ]<space> :<c-u>put! repear(nr2char(10),v:count1)<cr>
...
" 光标放到当前⾏末尾之后，默认情况下你是不可能做到的，但是可能通过设置virtualedit 选项达到目的
"set virtualedit=all
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
""""""""""""""""""""""""""""""""快捷键定义"""""""""""""""""""""""""""""""""""""""""""''
...
if strftime('%H') >= 7 && strftime('%H') < 22
    ...
    let themes = [
        ...
        \ 'vividchalk', 'PaperColor', 'gruvbox','violet','space-vim-theme',
        \ ]
